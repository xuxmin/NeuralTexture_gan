...
class Generator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf):
        ...
        # self.batch_norm = nn.BatchNorm2d(ngf, momentum=0.5)
        # self.batch_norm2 = nn.BatchNorm2d(ngf * 2, momentum=0.5)
        # self.batch_norm4 = nn.BatchNorm2d(ngf * 4, momentum=0.5)
        # self.batch_norm8 = nn.BatchNorm2d(ngf * 8, momentum=0.5)

        self.batch_norm = nn.InstanceNorm2d(ngf)
        self.batch_norm2 = nn.InstanceNorm2d(ngf * 2)
        self.batch_norm4 = nn.InstanceNorm2d(ngf * 4)
        self.batch_norm8 = nn.InstanceNorm2d(ngf * 8)
